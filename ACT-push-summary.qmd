...
mt <- merge(mt, pis[, .(trackercode, PI)])
...
mt <- mt[, .(PI, resource_full_name, network, code, detections, individuals)]
setnames(mt, c('PIs', 'Project name', 'Network', 'Project code', 'Detections', 'Individuals'))
